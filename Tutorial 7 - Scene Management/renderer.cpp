...
void Renderer::SortNodeLists() {
	std::sort(transparentNodeList.begin(), transparentNodeList.end(), SceneNode::CompareByCamereDistance);
	std::sort(nodeList.begin(), nodeList.end(), SceneNode::CompareByCamereDistance);
}
